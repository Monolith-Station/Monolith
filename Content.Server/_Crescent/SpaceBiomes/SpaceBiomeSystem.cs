...
//         if (!TryComp<StationNameSetupComponent>(parentStation, out var setup))
//             return;

//         var description = ""; //fallback if shuttle/station has no description

//         if (TryComp<VesselInfoComponent>(parentStation, out var desc)) //if this succeeds, we have a description! if it fails,
