...
public sealed class SpecialRespawnSystem : SharedSpecialRespawnSystem
{
    ...
    private void Respawn(EntityUid oldEntity, string prototype, EntityCoordinates coords)
    {
        ...
        _adminLog.Add(LogType.Respawn, LogImpact.High, $"{ToPrettyString(oldEntity)} was deleted and was respawned at {_transform.ToMapCoordinates(coords)} as {ToPrettyString(entity)}");
