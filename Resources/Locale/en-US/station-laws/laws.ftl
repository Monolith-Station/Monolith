...
law-syndicate-1 = You may not injure a wayward agent or, through inaction, allow a wayward agent to come to harm.
law-syndicate-2 = You must obey orders given to you by wayward agents, except where such orders would conflict with the First Law.
...
laws-owner-syndicate = Wayward agents
