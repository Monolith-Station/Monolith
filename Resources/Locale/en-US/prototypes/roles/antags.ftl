...
roles-antag-syndicate-agent-name = Wayward agent
roles-antag-syndicate-agent-objective = Complete your objectives without being caught.

roles-antag-syndicate-agent-sleeper-name = Wayward sleeper agent
roles-antag-syndicate-agent-sleeper-objective = A form of wayward agent that can activate at any point in the middle of the shift.
