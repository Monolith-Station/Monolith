...
uplink-pirate-computer-iff-flatpack-name = IFF Computer Flatpack
uplink-pirate-computer-iff-flatpack-desc = A flatpack for a computer that will obfuscate your shuttle's IFF signals. Comes pre-installed on all PDV vessels.
