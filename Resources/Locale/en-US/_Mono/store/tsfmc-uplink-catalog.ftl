...
uplink-security-t1-pernach-voucher-name = TSFMC Pernach LPC [T1]
uplink-security-t1-pernach-voucher-desc = A small card that contains the data for the procurement of a Pernach-class escort from the flagship's reserves.
