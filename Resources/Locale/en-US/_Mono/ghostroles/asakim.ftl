...
ghost-role-information-asakim-rules = You are an [color=#05e6ff][bold]Asakim[/bold][/color], a genetically engineered super soldier, awoken in deep space after a random cryostasis failure. It has been centuries since your last mission. Your allies are other Asakim warriors and potentially the [color=#00CCFF]ADS fleet[/color].
                                             ...
                                             -Claim Points Of Interest. (Excluding Colossus Central)
                                             -Secure the region against hostile factions. (TSF, PDV, Chimera)
                                             -Confiscate stolen (pre-fracture) technology. (Data Disks, Weaponry, MS-250/MS-500 shields, ect)
