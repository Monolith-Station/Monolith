...
uplink-security-pulsepistol-desc = A high powered laser pistol normally reserved as a sidearm for TSFMC and TSFN officers. Has an internal battery, but requires using a security charging dock.
uplink-security-pulsecarbine-name = Pulse Carbine
uplink-security-pulsecarbine-desc = A high powered laser carbine normally reserved for elite TSFMC units. Has an internal battery, but requires using a security charging dock.
