...
bounty-description-artifact = Someone is in some hot water for stealing artifacts from non-spacefaring planets. Return one and we'll compensate you for it.
...
bounty-description-donut = CentComm's security forces are facing heavy losses. Ship donuts to raise morale.
...
bounty-description-knife = One of our top commanders recently won a brand new set of knives on an official gameshow. Unfortunately, we don't have a set on hand. Send us a bunch of sharp things so we can throw something together.
...
bounty-description-pancake = Here we consider employees to be family. And you know what families love? Pancakes. Ship a baker's dozen.
...
bounty-description-soup = To quell the homeless uprising, we will be serving soup to all underpaid workers. Ship any type of soup.
