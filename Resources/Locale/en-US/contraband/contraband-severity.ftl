...
contraband-examine-text-GrandTheft = [color=red]This item is a highly valuable target![/color]
contraband-examine-text-Syndicate = [color=crimson]This item is highly illegal wayward contraband![/color]
contraband-examine-text-Magical = [color=#b337b3]This item is highly illegal wayward contraband![/color]
