osay-command-description = Obliga a otra entidad a intentar enviar un mensaje
osay-command-help-text = Uso: {$command} <uid> <tipo> <mensaje>

osay-command-arg-uid = uid de origen
osay-command-arg-type = tipo
osay-command-arg-message = mensaje

osay-command-error-args = Número de argumentos inválido
