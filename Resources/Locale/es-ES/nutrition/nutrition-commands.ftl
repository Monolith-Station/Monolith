...
cmd-hungry-help = establece tu nivel de hambre a famélico
cmd-setnutrit-desc = modifica el hambre y la sed
cmd-setnutrit-help = establece tu hambre o sed a uno de los umbrales predefinidos
cmd-setnutrit-error-invalid-threshold = {$thresholdType} inválido `{$thresholdString}`

cmd-thirsty-desc = te da sed
cmd-thirsty-help = establece tu nivel de sed a deshidratado
