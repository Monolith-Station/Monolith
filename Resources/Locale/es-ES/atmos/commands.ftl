cmd-set-map-atmos-desc = Establece la atmósfera de un mapa
cmd-set-map-atmos-help = setmapatmos <mapid> <space> [<temperature> [moles...]]
cmd-set-map-atmos-removed = Atmósfera eliminada del mapa {$map}
cmd-set-map-atmos-updated = Atmósfera configurada para el mapa {$map}
