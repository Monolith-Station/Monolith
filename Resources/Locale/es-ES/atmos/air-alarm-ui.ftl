...
air-alarm-ui-window-tab-vents = Ventilaciones
...
air-alarm-ui-mode-filtering = Filtración
air-alarm-ui-mode-wide-filtering = Filtración (amplia)
...
air-alarm-ui-widget-copy-tooltip = Copia la configuración de este dispositivo a todos los dispositivos en esta pestaña de alarma de aire.
...
air-alarm-ui-scrubber-volume-rate-label = Tasa (L)
...
air-alarm-ui-thresholds-upper-warning-bound = Advertencia por encima
air-alarm-ui-thresholds-lower-warning-bound = Advertencia por debajo
