atmos-alerts-window-title = Ordenador de Alertas Atmosféricas
...
atmos-alerts-window-silence-alerts = Silenciar alertas de esta alarma
...
atmos-alerts-window-no-active-alerts = [font size=16][color=white]Sin alertas activas -[/color] [color={$color}]Situación normal[/color][/font]
...
atmos-alerts-window-flavor-left = Contacta con un técnico atmosférico para obtener ayuda
