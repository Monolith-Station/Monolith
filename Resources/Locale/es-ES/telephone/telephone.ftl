# Envoltura del mensaje de teléfono en la ventana de chat (prefijo y sufijo)
...
# ID de llamante
chat-telephone-unknown-caller = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Llamante desconocido[/bolditalic][/font][/color]
...
chat-telephone-unknown-device = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Fuente desconocida[/bolditalic][/font][/color]
