...
general-station-record-console-record-title = Trabajo: {$job}
general-station-record-console-record-species = Especie: {$species}
general-station-record-console-record-gender = Género: {$gender}
general-station-record-console-record-fingerprint = Huella digital: {$fingerprint}
general-station-record-console-record-dna = ADN: {$dna}

general-station-record-for-filter-line-placeholder = Introduce texto y pulsa "Enter"
