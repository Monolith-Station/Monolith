...
ame-controller-component-fuel-slot-success-insert = Insertas el frasco en la ranura de combustible.
...
ame-window-toggle-injection-button = Activar/Desactivar Inyección
...
ame-window-refresh-parts-button = Actualizar Piezas
