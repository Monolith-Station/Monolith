...
ui-options-title = Ігрові налаштування
...
ui-options-ambient-music-volume = Гучність амбієнтної музики:
ui-options-ambience-volume = Гучність амбієнту:
...
ui-options-combat-music = Бойова музика
...
ui-options-hud-theme = Тема інтерфейсу:
